# Script to update a VMs GPU resource allocation after its creation
...
Assign-VMGPUPartitionAdapter -GPUName AUTO -VMName GPUPV -GPUResourceAllocationPercentage 25